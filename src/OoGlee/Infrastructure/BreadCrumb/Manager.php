...
use Ooglee\Infrastructure\BreadCrumb\CurrentRoute;
use Ooglee\Infrastructure\BreadCrumb\Generator;
use Ooglee\Infrastructure\BreadCrumb\View;
...
class Manager {
	...
	public function register($name, $callback)
	{
		...
		{
			throw new BreadCrumbException("Breadcrumb name \"{$name}\" has already been registered");
		}
